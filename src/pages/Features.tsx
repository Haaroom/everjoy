    ...
    <div className="min-h-screen bg-gradient-to-br from-[#5D4037] via-[#4E342E] to-[#3E2723]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-[#FFF8E1] rounded-2xl shadow-2xl p-8 md:p-12 mb-12">
          ...
          <p className="text-xl text-[#5D4037] text-center font-semibold">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-[#FFF8E1] rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all hover:scale-105 border-t-4 border-[#D4AF37]"
            >
        ...
        <div className="bg-[#FFF8E1] rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <p className="text-xl text-[#D4AF37] font-semibold text-center mb-8">
            EVERJOY: Pure Indulgence, Consciously Crafted
          </p>
          <p className="text-lg text-[#5D4037] text-center mb-12 max-w-3xl mx-auto">
            Our Unique Selling Proposition (USP) sets us apart from industry giants.
          </p>

          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-gradient-to-br from-[#6D4C41] to-[#5D4037] text-[#FFF8E1] rounded-xl p-6">
          ...
          <div className="bg-gradient-to-r from-[#D4AF37] to-[#C5A572] rounded-xl p-8 text-center">
