    ...
    <div className="min-h-screen bg-gradient-to-br from-[#5D4037] via-[#4E342E] to-[#3E2723]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <section className="bg-[#FFF8E1] rounded-2xl shadow-2xl p-8 md:p-12 mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#3E2723] mb-6 text-center">
            INTRODUCTION OF <span className="text-[#D4AF37]">MARKETING</span>
          </h1>
          <p className="text-lg md:text-xl text-[#5D4037] leading-relaxed text-center max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#FFF8E1] rounded-xl p-6 shadow-lg border-l-4 border-[#D4AF37]">
        ...
        <section className="bg-[#FFF8E1] rounded-2xl shadow-2xl p-8 md:p-12 mb-12">
          ...
          <p className="text-xl md:text-2xl text-[#D4AF37] font-semibold text-center mb-6">
            "Handcrafted goodness for every age"
          </p>
          <p className="text-lg text-[#5D4037] leading-relaxed mb-8 text-center max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-[#6D4C41] to-[#5D4037] text-[#FFF8E1] p-6 rounded-xl text-center">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-[#FFF8E1] rounded-xl p-6 shadow-lg hover:shadow-2xl transition-shadow">
